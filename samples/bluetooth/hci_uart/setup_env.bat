...
set PATH=%MY_TOOLCHAIN_DIR%;%MY_TOOLCHAIN_DIR%\mingw64\bin;%MY_TOOLCHAIN_DIR%\opt\bin;%MY_TOOLCHAIN_DIR%\opt\bin\Scripts;%MY_TOOLCHAIN_DIR%\segger_embedded_studio\bin;%PATH%
set GNUARMEMB_TOOLCHAIN_PATH=%MY_TOOLCHAIN_DIR%\opt
